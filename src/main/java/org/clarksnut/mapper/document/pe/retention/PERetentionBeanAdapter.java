...
public class PERetentionBeanAdapter implements DocumentBean {

    private final RetentionType type;

    public PERetentionBeanAdapter(RetentionType type) {
        this.type = type;
    }
    ...
    public Double getAmount() {
        AmountType sunatTotalCashed = type.getSunatTotalPaid();
