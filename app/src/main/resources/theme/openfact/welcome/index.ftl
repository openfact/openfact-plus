...
<div class="wrapper">
    <div class="content">
        <div class="logo">
            <img src="welcome-content/clarksnut_logo.png" alt="Clarksnut" border="0"/>
        </div>
        <h1>Welcome to Clarksnut</h1>
        
        <p><a href="http://www.clarksnut.org/docs">Documentation</a> | <a href="admin/">Administration Console</a></p>

        <p><a href="http://www.clarksnut.org">Clarksnut Project</a> |
            <a href="https://lists.jboss.org/mailman/listinfo/clarksnut-user">Mailing List</a> |
            <a href="https://issues.jboss.org/browse/ClARKSNUT">Report an issue</a></p>
