...
public class PerceptionLineBean {
    ...
    private Float montoTotalACobrar;
    private String monedaACobrar;
    ...
    public Float getMontoTotalACobrar() {
        return montoTotalACobrar;
    }

    public void setMontoTotalACobrar(Float montoTotalACobrar) {
        this.montoTotalACobrar = montoTotalACobrar;
    }

    public String getMonedaACobrar() {
        return monedaACobrar;
    }

    public void setMonedaACobrar(String monedaACobrar) {
        this.monedaACobrar = monedaACobrar;
    }
