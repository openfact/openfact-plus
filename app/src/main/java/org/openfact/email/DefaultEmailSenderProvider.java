...
public class DefaultEmailSenderProvider implements EmailSenderProvider {
    ...
    @Override
    public void send(EmailUserModel user, String subject, String textBody, String htmlBody) throws EmailException {
        send(user, subject, textBody, htmlBody, null);
    }

    @Override
    public void send(EmailUserModel user, String subject, String textBody, String htmlBody, List<EmailFileModel> attachments) throws EmailException {
