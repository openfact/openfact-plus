package org.openfact.models.db.search.reader.basic.creditnote;
...
public class BasicCreditNoteEntity {
    ...
    private List<BasicCreditNoteLineEntity> lines = new ArrayList<>();
    ...
    public List<BasicCreditNoteLineEntity> getLines() {
        return lines;
    }

    public void setLines(List<BasicCreditNoteLineEntity> lines) {
        this.lines = lines;
    }
}
