package org.openfact.models.db.connections.jpa.entityprovider;

import java.util.List;

/**
 * A JPA Entity Provider can supply extra JPA entities that Openfact system should include in it's entity manager. The
