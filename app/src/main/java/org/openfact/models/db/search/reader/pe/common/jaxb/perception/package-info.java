...
@javax.xml.bind.annotation.XmlSchema(namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2",
        ...
        @XmlNs(namespaceURI = "urn:sunat:names:specification:ubl:peru:schema:xsd:Perception-1", prefix = ""),
        @XmlNs(namespaceURI = "http://www.w3.org/2001/XMLSchema-instance", prefix = "xsi")
})
package org.openfact.models.db.search.reader.pe.common.jaxb.perception;
