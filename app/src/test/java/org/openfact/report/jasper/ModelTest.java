...
import org.openfact.datasource.ModelBean;
...
public class ModelTest {
    ...
    public void test() throws IOException, JRException {
        ...
        URL headerTopLeftUrl = classLoader.getResource("report/openfact/model/resources/header_top_left.png");
        URL backgroundUrl = classLoader.getResource("report/openfact/model/resources/background.png");
        ...
        URL resourceBundleURL = classLoader.getResource("report/openfact/model/messages/messages_es.properties");
...
//        JasperExportManager.exportReportToPdfStream(jp, output);
    ...
    public JasperReport getReport() throws IOException, JRException {
        ClassLoader classLoader = getClass().getClassLoader();
        URL url = classLoader.getResource("report/openfact/model/model.jrxml");
    ...
    public List<ModelBean> getDatasource() {
        ...
        model1.setLocation("www.openfact.com/documents/1");
        ...
        model2.setLocation("www.openfact.com/documents/2");
